...
const AIRPORTS = [
  ...
  { icao: 'KC Cowboy', name: 'Copper Country', type: 'small' },
  // Ohio
  ...
  // Texas
  { icao: 'KDraughon', name: 'Draughon-Miller Central Texas', type: 'small' },
  ...
  // Pennsylvania
  { icao: 'KPHL', name: 'Philadelphia International', type: 'small' },
