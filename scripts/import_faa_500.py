"""
Import FAA data - 500 records at a time
Run: python scripts/import_faa_500.py

Then run: python scripts/import_faa_500.py 2
     etc
"""
...
print(f"\nNext: python scripts/import_faa_500.py {part+1}")
